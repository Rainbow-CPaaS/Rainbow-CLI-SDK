...
class CAccount {
    ...
    getCommands(options) {
        ...
        if (that._prefs && that._prefs.user && that._prefs.user.roles.includes("app_superadmin")) {
            var data_dev = [
        ...
        if(that._prefs && that._prefs.user && that._prefs.user.roles.includes("superadmin")) {
            var data_superadmin = [
                {
                    "level": "----------", 
                    "theme": "----------", 
