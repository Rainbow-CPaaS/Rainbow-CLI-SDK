...
class COffers {
    ...
    _getCatalog(token, id) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            NodeSDK.get('/api/rainbow/admin/v1.0/catalogs/' + id, token).then(function(json) {
                resolve(json);
            }).catch(function(err) {
                reject(err);
            });
    ...
    _createCatalog(token, name, description) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            NodeSDK.post('/api/rainbow/admin/v1.0/catalogs', token, {name: name, description: description}).then(function(json) {
                resolve(json);
            }).catch(function(err) {
                reject(err);
            });
    ...
    _deleteCatalog(token, id, options) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            NodeSDK.delete('/api/rainbow/admin/v1.0/catalogs/' + id, token).then(function(json) {
                resolve(json);
            }).catch(function(err) {
                reject(err);
            });
    ...
    _getListOfCatalogs(token, options) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            NodeSDK.get('/api/rainbow/admin/v1.0/catalogs?format=full' + filterToApply + offset + limit, token).then(function(offers) {
                resolve(offers);
            }).catch(function(err) {
                reject(err);
            });
    ...
    _getOffer(token, id) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            NodeSDK.get('/api/rainbow/admin/v1.0/offers/' + id, token).then(function(json) {
                resolve(json);
            }).catch(function(err) {
                reject(err);
            });
    ...
    _getListOfOffers(token, options) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            NodeSDK.get('/api/rainbow/admin/v1.0/offers?format=full' + filterToApply + offset + limit, token).then(function(offers) {
                resolve(offers);
            }).catch(function(err) {
                reject(err);
            });
